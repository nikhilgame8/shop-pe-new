              ...
              <div className="mx-auto flex h-10 max-w-7xl items-center justify-end px-4 sm:px-6 lg:px-8">
                ...
                {/* <form>
                  <div>
                    ...
                    <div className="group relative -ml-2 rounded-md border-transparent bg-themePurpleText focus-within:ring-2 focus-within:ring-white">
                      <select
                        id="desktop-currency"
                        name="currency"
                        className="flex items-center rounded-md border-transparent bg-themePurpleText bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-white focus:border-transparent focus:outline-none focus:ring-0 group-hover:text-gray-100"
                      >
                        {currencies.map((currency) => (
                          <option key={currency}>{currency}</option>
                        ))}
                ...
                <div>
                  <div className="flex h-16 items-center justify-between">
                              ...
                              {({ open }) => (
                                <>
                                  <div className="relative flex">
                                    <Popover.Button className="relative z-10 flex items-center justify-center text-sm font-medium text-gray-900 transition-colors duration-200 ease-out">
                                      {category.name}
                                      <span
                                        ...
                                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                          <div className="grid grid-cols-4 gap-x-8 gap-y-10 py-16">
                                            {category.featured.map((item) => (
                                              ...
                                              >
                                                <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-900 group-hover:opacity-75">
                                                  <img
                                                    src={item.imageSrc}
                                                    alt={item.imageAlt}
                                                    className="object-cover object-center"
                    ...
                    <div className="flex flex-1 items-center lg:hidden">
                      ...
                      {/* Search */}
                      <a href="#" className="ml-2 p-2 text-gray-900">
                    ...
                    {/* Logo (lg-) */}
                    <a href="#" className="lg:hidden flex gap-2">
                      <span className="sr-only">Your Company</span>
                      <img
                        src="https://blog.pollpe.com/assets/img/logo.svg"
                        alt=""
                        className="h-8 w-auto"
                      />
                      <span class="self-center text-base sr-only font-semibold whitespace-nowrap ">
                        ShopPe
                      </span>
                    </a>
                    ...
                    <div className="flex flex-1 items-center justify-end">
                      ...
                      <div className="flex items-center lg:ml-8">
                        {/* Help */}
                        {/* <a href="#" className="p-2 text-gray-900 lg:hidden">
                        ...
                        <div className="ml-4 flow-root lg:ml-8">
                          ...
                          >
                            ...
                            <span className="sr-only">user coins</span>
                            <FontAwesomeIcon
                              icon={faStar}
                              className="absolute -left-2 top-1 text-themePurpleText w-6 h-6"
                            />
                            <span class="bg-themeLightBgPurple pl-3 text-themePurpleText text-xs font-medium px-2.5 py-0.5 rounded-full  ">
                              150
                            </span>
                          </button>
                        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 py-10">
            <p className="text-sm text-gray-400">
              Copyright &copy; 2023 Your Company, Inc.
            </p>
          </div>
        </div>
      </footer>
