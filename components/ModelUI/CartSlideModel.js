...
const CartSlideModel = ({show, setShow}) => {
    return (
        <>
            <div>
                ...
                {show && (
                    <div className="w-full h-full bg-black bg-opacity-90 z-20 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0" id="chec-div">
                        <div className="w-full absolute z-50 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
                            <div className="flex md:flex-row flex-col justify-end" id="cart">
                                ...
                                <div className="md:w-1/3 xl:w-1/4 w-full bg-themeLightBgPurple h-full">
                                    <div className="flex flex-col md:h-screen px-14 py-20 justify-between overflow-y-auto">
                                        ...
                                        <div>
                                            ...
                                            <button onClick={() => setShow(!show)} className="text-base leading-none w-full py-5 bg-themePurpleText border-themePurpleText border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-themePurpleText text-white">
                                                Checkout
                                            </button>
                                        </div>
                                    </div>
