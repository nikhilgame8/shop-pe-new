        ...
        {products.map((product) => (
          <SwiperSlide>
            <a key={product.id} href={product.href} className="group">
              <div className="aspect-h-1 my-4 shadow-lg aspect-w-1 w-full overflow-hidden rounded-full bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                <img
              ...
              <p className="mt-2 text-center text-sm font-semibold text-gray-700">{product.name}</p>
            </a>
          </SwiperSlide>
        ))}
      </Swiper>
