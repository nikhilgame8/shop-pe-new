    ...
    <div className="bg-white relative">
      ...
      >
        {products.map((product) => (
          <SwiperSlide className="border border-gray-300 rounded-lg shadow">
            <a key={product.id} href={product.href} className="group">
              <div className="aspect-h-1 rounded-t-lg aspect-w-1 shadow-lg w-full overflow-hidden bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                <img
